...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getFolders = function (id, access_token) {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/folder/" + id, { headers: localheaders });
    };
    UserService.prototype.getGenreList = function (access_token) {
        var localheaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
            'Authorization': "Bearer " + access_token
        });
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/genre", { headers: localheaders });
    };
    UserService.prototype.getScriptDetails = function (id, access_token) {
        var localheaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
            'Authorization': "Bearer " + access_token
        });
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/script/" + id + "/details", { headers: localheaders });
    };
    UserService.prototype.getScriptSentiments = function (id, access_token) {
        var localheaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
            'Authorization': "Bearer " + access_token
        });
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/script/" + id + "/sentiments", { headers: localheaders });
    };
    UserService.prototype.postFile = function (fileToUpload, access_token, genreValue) {
        var _this = this;
        var localheaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
            'Authorization': "Bearer " + access_token
        });
        var endpoint = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/script";
...
/* harmony import */ var _folder__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./folder */ "./src/app/folder/index.ts");
...
/* harmony import */ var _script_script_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./script/script.component */ "./src/app/script/script.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _folder__WEBPACK_IMPORTED_MODULE_8__["FolderComponent"],
                _login__WEBPACK_IMPORTED_MODULE_9__["LoginComponent"],
                _register__WEBPACK_IMPORTED_MODULE_10__["RegisterComponent"],
                _script_script_component__WEBPACK_IMPORTED_MODULE_11__["ScriptComponent"]
            ],
            providers: [
...
var FolderComponent = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, this.userService.getGenreList(this.currentUser.access_token)
                                .subscribe(function (genreList) {
    ...
    FolderComponent.prototype.dropdownValue = function (value) {
        this.genreValue = value;
    };
    FolderComponent.prototype.uploadFileToActivity = function () {
        this.userService.postFile(this.fileToUpload, this.currentUser.access_token, this.genreValue).subscribe(function (data) {
...
var ScriptComponent = /** @class */ (function () {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.userService.getScriptDetails(this.scriptId, this.currentUser.access_token)
                                ...
                                console.log(_this.scriptScores);
                                _this.loading = true;
                                KTFlotchartsDemo();
                            }, function (error) {
                                _this.alertService.error(error);
    ...
    ScriptComponent.prototype.getSentimentGraphs = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.getScriptSentiments(this.scriptId, this.currentUser.access_token)
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])())
                            .subscribe(function (data) {
                            _this.sentiment_data = data;
                            console.log(_this.sentiment_data);
                        }, function (error) {
                            _this.alertService.error(error);
                        })];
                    case 1:
